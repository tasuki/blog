...
<style>
.solartile { border: 1px solid #cb4b16; float: left; margin: 9px; line-height: 50px; width: 50px; height: 120px; writing-mode: vertical-lr; transform: rotate(180deg); }
.solartall { height: 130px; }
.solartile tt { padding: 7px; }
</style>

> **[Update]:** This post was my first foray into colours. I've since [perfected the colour scheme](/solar-v2/) and also [made a tiny version](/minisolar/).
