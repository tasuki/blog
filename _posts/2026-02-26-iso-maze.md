...
> [Edit:] As of 2026-03-07 this is now [playable with 18 mazes](https://maze.tasuki.org/). It runs in the browser, no need to install anything. You might still want to install it as PWA on mobile to get full-screen.
